...
(function () {
  ...
  const researcherInline = (s, version, policy) => {
    ...
    return 'The authors disclose the use of ' + tools + ' for ' + tasksFrag +
      '; the resulting contributions were critically reviewed and the authors take full responsibility for the content (generated by Themis (FMUP · IA), v' + version + fw + ').';
  };
